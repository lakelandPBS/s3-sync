This is a bash script that uses Amazons python package, `awscli`, to sync local files to Amazons S3. **WARNING!**: This script will delete files from the S3 bucket if they don't exist on the local file system.
